<?php
	...
	if ($_SESSION['role'] == "Head"){
		...
		WHERE users.users_id = ".$_SESSION['userId']." AND issue.assigned_to = ".$_SESSION['userId']." AND equipment.equipment_id = issue.machine_id AND equipment.location_id = location.location_id
...
?>
			...
			?>
				<tr>
					...
					<td class="text-center"> </td>
					<td class="text-center"> </td>
					<td class="text-center"> There are no Tasks to be done.</td>
					<td class="text-center"></td>
					<td class="text-center"></td>
					<td class="text-center"></td>
					<td class="text-center"></td>
