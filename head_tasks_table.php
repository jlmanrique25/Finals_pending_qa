...
<div class="container-fluid py-4 overflow-hidden">
    <div class="container py-4 ">
        ...
        <a href="head_tasks_table.php?site=Unresolved%20Issues&table=unresolved" type="button" class="btn btn-warning btn-lg my-2">Unresolved Issues</a>
        <a href="head_tasks_table.php?site=Resolved%20Issues&table=resolved" type="button" class="btn btn-success btn-lg my-2">Resolved Issues</a>
